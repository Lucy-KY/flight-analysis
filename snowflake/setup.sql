...
-- ============================================================
-- Phase 1: FAA NAS Status tables (added 2026-04-07)
-- ============================================================

USE DATABASE FLIGHT_DB;
USE SCHEMA RAW;

CREATE OR REPLACE TABLE RAW.FAA_NAS_STATUS_RAW (
...
CREATE OR REPLACE STAGE RAW.FAA_NAS_STAGE
    FILE_FORMAT = (TYPE = PARQUET);

USE SCHEMA ANALYTICS;

CREATE OR REPLACE TABLE ANALYTICS.AIRPORT_NAS_STATUS (
    FETCH_DATE         DATE,
    IATA_CODE          VARCHAR(5),
...
-- ============================================================
-- Phase 2: Weather data tables (added 2026-04-07)
-- ============================================================

CREATE OR REPLACE TABLE RAW.AIRPORT_WEATHER_HOURLY (
...
-- Weather correlation analytics table
CREATE OR REPLACE TABLE ANALYTICS.WEATHER_DELAY_CORRELATION (
    YEAR                INTEGER,
    MONTH               INTEGER,
    IATA_CODE           VARCHAR(5),
    AVG_TEMP_C          FLOAT,
...
-- Add weather columns to STAGING.FLIGHTS
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS ORIGIN_TEMP_C          FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS ORIGIN_PRECIP_MM       FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS ORIGIN_SNOWFALL_CM     FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS ORIGIN_WIND_SPEED_KMH  FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS ORIGIN_WIND_GUST_KMH   FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS ORIGIN_VISIBILITY_M    FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS ORIGIN_CLOUD_COVER_PCT FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS ORIGIN_WEATHER_CODE    INTEGER;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS DEST_TEMP_C            FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS DEST_PRECIP_MM         FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS DEST_WIND_SPEED_KMH    FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS DEST_VISIBILITY_M      FLOAT;
ALTER TABLE STAGING.FLIGHTS ADD COLUMN IF NOT EXISTS DEST_WEATHER_CODE      INTEGER;
